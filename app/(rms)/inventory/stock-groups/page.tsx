...
import {
  Layers, DollarSign, Star, MoreHorizontal, Pencil, Trash2, Box, X,
} from "lucide-react";
...
import { StockGroupRow, STOCK_GROUPS } from "@/components/rms/data/inventory";
import { GroupModal } from "@/components/stock/GroupModal";
...
function GroupDrawer({
  ...
  const itemsInGroup = useMemo(
    () => ITEMS.filter((i) => i.groups.includes(group.name)),
    [group.name],
  );
